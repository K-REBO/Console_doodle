...
int main(void) {
	...
	switch (a) {
	case 0:break;
	case 1:H_Map = H_Map_1; break;
	case 2:H_Map = H_Map_2; break;
	case 3:H_Map = H_Map_3; break;
	case 4:H_Map = H_Map_4; break;
	case 5:H_Map = H_Map_5; break;
	}
